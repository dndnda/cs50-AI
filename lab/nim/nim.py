...
class NimAI():
    ...
    def choose_action(self, state, epsilon=True):
        ...
        def greedy():
            ...
            rt = actions_copy.pop()
            max_val = 0 if (tuple(state), tuple(rt)) not in self.q else self.q[(tuple(state), tuple(rt))]
        ...
        if epsilon is False:
            ...
            random_choose = random.choice(list(actions))
            return random.choices([greedy_rt, random_choose], weights=[1-epsilon, epsilon])[0]
